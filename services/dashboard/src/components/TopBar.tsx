...
export default function TopBar({ totalCount }: { totalCount: number }) {
      ...
      <div className="flex items-center gap-3">
        <svg width="26" height="26" viewBox="0 0 24 24" fill="none">
          <path d="M12 2L3 6v6c0 5 3.8 8.7 9 10 5.2-1.3 9-5 9-10V6l-9-4z"
            fill="none" stroke="#38E1C6" strokeWidth="1.6" />
          <path d="M8.5 12l2.3 2.3L15.5 9" stroke="#38E1C6" strokeWidth="1.6"
